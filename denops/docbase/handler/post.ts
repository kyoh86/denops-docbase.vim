...
import * as variable from "jsr:@denops/std@~7.2.0/variable";
import { getbufline } from "jsr:@denops/std@~7.2.0/function";
...
import type { Buffer } from "jsr:@kyoh86/denops-router@~0.3.0-alpha.5";
