...
import * as variable from "https://deno.land/x/denops_std@v6.4.2/variable/variable.ts";
import { getbufline } from "https://deno.land/x/denops_std@v6.4.2/function/buffer.ts";
